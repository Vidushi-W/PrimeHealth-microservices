...
import { getMyProfile, updateMyProfile } from '../services/patientApi';
    ...
    <div className="dashboard animate-fade-in">
      ...
      <div className="dashboard-grid dashboard-grid-tight">
        ...
        <div className="dashboard-card glass">
          ...
          <p className="card-value">{profileData?.profile.emergencyContactName || 'Add a trusted contact'}</p>
          <p className="text-muted">{profileData?.profile.emergencyContactPhone || 'No emergency phone saved'}</p>
        </div>
      </div>
